...
from app.adapter.dto import (NameQueryDto, OrganizationDto,
                             ...
                             organization_geo_query_dto, organization_name_query_dto)
...
async def get_organization_by_geo(
...
async def get_organization_by_activity_name(
        query: NameQueryDto = Depends(organization_name_query_dto),
        adapter: DataBaseAdapter =  Depends(get_database_adapter),
) -> List[OrganizationDto]:
...
async def get_organization_by_organization_name(
        query: NameQueryDto = Depends(organization_name_query_dto),
        adapter: DataBaseAdapter =  Depends(get_database_adapter),
) -> List[OrganizationDto]:
